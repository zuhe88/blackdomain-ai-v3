...
async function requestEmbeddedStorage(){if(!embedded||typeof document.requestStorageAccess!=="function")return;try{if(typeof document.hasStorageAccess!=="function"||!(await document.hasStorageAccess()))await document.requestStorageAccess()}catch{}}
