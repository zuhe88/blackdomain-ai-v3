        ...
        document.body.innerHTML = `
          <style>
            ...
            *{box-sizing:border-box}html,body{margin:0;min-height:100%;background:#02050b!important;color:#fff!important;font-family:Inter,"Segoe UI","Noto Sans TC",system-ui,sans-serif}body{overflow-x:hidden}
            ...
            .ops{position:relative;isolation:isolate;min-height:100vh;padding:25px clamp(24px,5vw,72px) 23px;background-image:linear-gradient(135deg,rgba(2,8,16,.93),rgba(3,13,25,.86));color:#fff!important}.ops:after{content:"";position:fixed;z-index:-1;width:min(62vw,760px);aspect-ratio:1;left:50%;top:50%;transform:translate(-50%,-50%);background:url("https://blackdomain-ai-v3-production.up.railway.app/brand/blackdomain-ai-logo.png") center/contain no-repeat;opacity:.11;filter:saturate(1.25) drop-shadow(0 0 55px rgba(255,190,61,.18));pointer-events:none}.topbar{display:flex;align-items:center;justify-content:space-between;gap:24px;padding-bottom:18px;border-bottom:2px solid rgba(57,216,255,.25)}
